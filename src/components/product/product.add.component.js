...
class ProductAdd extends Component {
  ...
  constructor(props) {
    ...
    if (this.props.location.edit) {
      axios
        .get(BACKEND_URL + `Product/${this.props.location.productid}`)
        .then((response) => {
  ...
  btnSaveOnClick(e) {
    ...
    if (this.state.isEdit) {
      ...
      axios
        .put(BACKEND_URL + `Product/${this.state.id}`, obj, {
          headers: {
