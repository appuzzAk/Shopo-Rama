...
class ProductList extends Component {
  ...
  proceedDelete() {
    ...
    axios
      .delete(BACKEND_URL + `Product/${this.state.deleteId}`, {
        headers: {
  ...
  updateStateAfterDelete(id) {
    console.log("Deleted!");
    this.setState({
      products: this.state.products.filter((b) => b.id !== id),
    });
  }
    ...
    return (
      <div>
        ...
        >
          ...
          <Tooltip title="Add Product" aria-label="Products">
            <IconButton
              aria-label="Products"
              className={classes.margin}
              component={Link}
              to={{ pathname: `/product/add`, edit: false }}
            >
              <AddIcon
                fontSize="small"
                style={{
                ...
                <CustomTableCell align="left">
                  ...
                  <Tooltip title="Delete Product" aria-label="Delete">
                    <IconButton
                      aria-label="Delete"
                      className={classes.margin}
                      onClick={this.btnDeleteOnClick.bind(this, product.id)}
                    >
